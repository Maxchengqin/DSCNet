...
from ops.dataset_sk_2d_seg_rand_ikea_with_confidence import MSSTdata
# from ops.dataset_sk_2d_seg_rand_ntu_with_confidence import MSSTdata
import torch
# options
parser = argparse.ArgumentParser(description="Standard video-level testing")
parser.add_argument('dataset', type=str, choices=['ucf101', 'hmdb51', 'kinetics', 'ntu', 'ntu120', 'uav', 'ikea', 'ikea_33'])
