...
class TSN(nn.Module):
    def __init__(self, num_class, num_segments, modality,
        ...
        self.TSM_intrada = STMEM(num_segments=num_segments, new_length=data_length)
    ...
    def forward(self, input, no_reshape=False):
        ...
        # print('22222222222', output_intrada.size())
        # if not no_reshape:
        #     sample_len = (3 if self.modality in ['RGB', 'motion', 'dense'] else 2) * self.new_length
        #
    ...
    def _get_diff(self, input, keep_rgb=False):
        input_c = 3 if self.modality in ["RGB", "RGBDiff", 'motion', 'dense'] else 2
    ...
    def get_augmentation(self, flip=True):
        if self.modality in['RGB', 'depth', 'motion', 'dense', 'depth_dense']:
            if flip:
